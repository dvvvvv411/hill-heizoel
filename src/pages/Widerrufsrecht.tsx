        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 text-sm leading-relaxed">
                Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (HILL-Clear Projects GmbH, Rottmannstr. 22a, 80333 München, E-Mail: info@hill-heizoel.de, Tel.: 089 123 456 789) mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief, Telefax oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren.
              </p>
